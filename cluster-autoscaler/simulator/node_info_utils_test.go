...
func TestTemplateNodeInfoFromNodeGroupTemplate(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.testName, func(t *testing.T) {
			templateNodeInfo, err := TemplateNodeInfoFromNodeGroupTemplate(tc.nodeGroup, testDaemonSets, taints.TaintConfig{})
			if tc.wantCpError {
...
func TestTemplateNodeInfoFromExampleNodeInfo(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			templateNodeInfo, err := TemplateNodeInfoFromExampleNodeInfo(exampleNodeInfo, nodeGroupId, tc.daemonSets, tc.forceDS, taints.TaintConfig{})
			if tc.wantError {
				if err == nil {
